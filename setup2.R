...
pairs3 = googlesheets4::read_sheet('https://docs.google.com/spreadsheets/d/18TpAK-rI31v7O5EVv1JD0ATsXd83lgKI-ZEZh1Q8L30/edit?usp=sharing', 'pass2')

pairs3$log_lemma_freq = log(pairs3$lemma_freq)
pairs3$log_freq = log((pairs3$lv_freq+pairs3$nlv_freq))

# -- write -- #

write_tsv(pairs3, 'lv_nlv_pairs_acc.tsv')
